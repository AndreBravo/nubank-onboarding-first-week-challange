...
(def credit-card-1-uuid (UUID/randomUUID))
(def credit-card-2-uuid (UUID/randomUUID))
(def credit-card-3-uuid (UUID/randomUUID))

(def credit-card-1 {:credit-card/uuid         credit-card-1-uuid
...
(def credit-card-2 {:credit-card/uuid         credit-card-2-uuid
...
(def credit-card-3 {:credit-card/uuid         credit-card-3-uuid
...
(def transaction-1 {:transaction/uuid             transaction-1-uuid
                    ...
                    :transaction/credit-card-uuid credit-card-1-uuid})
...
(def transaction-3 {:transaction/uuid             transaction-3-uuid
                    ...
                    :transaction/credit-card-uuid credit-card-2-uuid})
